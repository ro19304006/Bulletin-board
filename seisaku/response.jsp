...
<body>
    <div id="container">
        <div id="wrapper">
            <div id="header">
                <h1 align="center">
                    <form action='b_board.jsp'></form>
					<%-- <img src="rogo.jpg" width="160" height="160" alt="Free Board"> --%>
                </h1>
            </div>
        </div>
		<div class="response">
		<c:forEach var="list1" items="${b_boardlist}" ><br><br><br>
        ...
        <h5 align="center">
            <form method="POST" action="ResponseServlet">
                ...
                <input class="btn-3d-shadow" type='submit' name="btn1" value='書き込む' ><br><br>
				<%-- <div id="bottom"> --%>
			...
			<a href="/seisaku/B_boardServlet" class="btn-3d-shadow">top</a></div>
		</form>
        </h5>
    </div>
</body>
